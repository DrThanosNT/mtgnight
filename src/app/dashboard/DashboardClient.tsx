...
export default function DashboardClient({ displayName, groups }: { displayName: string; groups: Group[] }) {
  ...
  return (
    <div style={{ display: "flex", minHeight: "100dvh" }}>
      <Sidebar />
      <div style={{ flex: 1, maxWidth: 640, margin: "0 auto", padding: 24, color: "white" }}>
